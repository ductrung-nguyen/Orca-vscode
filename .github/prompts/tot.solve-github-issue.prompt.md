...
# tot.solve-github-issue.prompt.md (Shim)

**This is a shim file.** You MUST read and follow the full instructions in:

👉 **[@/.tot/prompts/tot.solve-github-issue.prompt.md](@/.tot/prompts/tot.solve-github-issue.prompt.md)**
